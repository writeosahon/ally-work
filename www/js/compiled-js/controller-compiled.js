...
_context2.next=6;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.WRITE_EXTERNAL_STORAGE,cordova.plugins.diagnostic.permission.READ_EXTERNAL_STORAGE]);});case 6:permissionStatuses=_context2.sent;// get the blob data when the export process is completed
...
window.plugins.toast.hide();}});}).catch(function(err){console.log("EXPORT FAILED",err);});case 8:case'end':return _context2.stop();}}},_callee2,this);}));function pdfExportComplete(_x2){return _ref2.apply(this,arguments);}return pdfExportComplete;}()});//append the newly created grid
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context3.stop();}}},_callee3,this);}));function pdfExportComplete(_x3){return _ref3.apply(this,arguments);}return pdfExportComplete;}()});// remove the loader content
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray);}).then(function(dataArray){var _ref5;console.log(dataArray);utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid=new ej.grids.Grid((_ref5={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref5,'allowTextWrap',true),_defineProperty(_ref5,'showColumnChooser',true),_defineProperty(_ref5,'allowPdfExport',true),_defineProperty(_ref5,'allowExcelExport',true),_defineProperty(_ref5,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref5,'columns',[{field:'SENDER',headerText:'Sender',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'RECEIVER',headerText:'Recipient',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',clipMode:'ellipsiswithtooltip'},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'TRANSFERTYPE',headerText:'Type',width:"25%",clipMode:'ellipsiswithtooltip',visible:false},{field:'TRANSACTIONREF',headerText:'Ref',width:"25%",clipMode:'ellipsiswithtooltip',visible:false}]),_defineProperty(_ref5,'dataSource',dataArray),_defineProperty(_ref5,'pdfExportComplete',function(){var _ref4=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee4(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context4.stop();}}},_callee4,this);}));function pdfExportComplete(_x4){return _ref4.apply(this,arguments);}return pdfExportComplete;}()),_ref5));// remove the loader content
$('#transaction-history-page #transaction-history-transaction-grid').html("");//append the newly created grid
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.appendTo('#transaction-history-transaction-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='transaction-history-transaction-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
...
// format the data array so it can be properly used
return gridDataMapping(data[periodType]);}).then(function(dataArray){var _ref7;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref7={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref7,'allowTextWrap',true),_defineProperty(_ref7,'showColumnChooser',true),_defineProperty(_ref7,'allowPdfExport',true),_defineProperty(_ref7,'allowExcelExport',true),_defineProperty(_ref7,'allowGrouping',true),_defineProperty(_ref7,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref7,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref7,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref7,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref7,'dataSource',dataArray),_defineProperty(_ref7,'pdfExportComplete',function(){var _ref6=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee5(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});case 7:case'end':return _context5.stop();}}},_callee5,this);}));function pdfExportComplete(_x7){return _ref6.apply(this,arguments);}return pdfExportComplete;}()),_ref7));//append the newly created grid
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray[periodType]);}).then(function(dataArray){var _ref9;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref9={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref9,'allowTextWrap',true),_defineProperty(_ref9,'showColumnChooser',true),_defineProperty(_ref9,'allowPdfExport',true),_defineProperty(_ref9,'allowExcelExport',true),_defineProperty(_ref9,'allowGrouping',true),_defineProperty(_ref9,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref9,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref9,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref9,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref9,'dataSource',dataArray),_defineProperty(_ref9,'pdfExportComplete',function(){var _ref8=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee6(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");// hide the spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});case 7:case'end':return _context6.stop();}}},_callee6,this);}));function pdfExportComplete(_x8){return _ref8.apply(this,arguments);}return pdfExportComplete;}()),_ref9));//append the newly created grid
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.appendTo('#expense-tracker-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='expense-tracker-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
