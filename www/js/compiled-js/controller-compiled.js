...
return dataObject;// return the modified object
         ...
         *
         * @param buttonElem
         */switchVizTypeButtonClicked:function switchVizTypeButtonClicked(buttonElem){var buttonVizTypeState=$(buttonElem).attr('data-ally-viz-type');// get the visualisation type state of the button
// handle the differnet buttonVizTypeState values
switch(buttonVizTypeState){case"grid":// current state is 'grid'. so, display charts now
// move the carousel to the 1st chart item
$('#expense-tracker-page #expense-tracker-carousel').get(0).setActiveIndex(1).then(function(){// change the button icon from chart to grid
$('ons-icon',buttonElem).attr("icon","md-grid");// update the button visualisation state attribute of the button
$(buttonElem).attr("data-ally-viz-type","chart");// display the chart visualisation mover button
...
$('#expense-tracker-page #expense-tracker-viz-mover-fab').attr("data-ally-viz-mover","up");});break;case"chart":// current state is 'chart'. so display grids
// move the carousel to the grid item
$('#expense-tracker-page #expense-tracker-carousel').get(0).setActiveIndex(2).then(function(){// change the button icon from grid to chart
$('ons-icon',buttonElem).attr("icon","md-chart");// update the button visualisation state attribute of the button
$(buttonElem).attr("data-ally-viz-type","grid");// hide the chart visualisation mover button
$('#expense-tracker-page #expense-tracker-viz-mover-fab').css("display","none");// set the icon for the mover button
$('#expense-tracker-page #expense-tracker-viz-mover-fab ons-icon').attr("icon","md-chevron-up");// set the visualisation mover value for the mover button
$('#expense-tracker-page #expense-tracker-viz-mover-fab').attr("data-ally-viz-mover","up");});break;}},/**
