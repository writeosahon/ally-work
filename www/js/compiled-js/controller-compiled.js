...
$('#app-main-navigator').get(0).pushPage('add-card-wallet-transfer-page.html',{data:formData,animation:'lift-md'});},/**
         ...
         * @param buttonElem
         * @returns {Promise}
         */walletTransferSmsConfirmButtonClicked:function(){var _ref=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(buttonElem){var walletTransferDetails,permissionStatuses;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:hockeyapp.trackEvent(function(){},function(){},"FUND TRANSFERRED");// track fund transfer
...
_context.next=5;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.SEND_SMS]);});case 5:permissionStatuses=_context.sent;// use a promise to send the sms confirmation message to the recipient
...
$('#wallet-transfer-page #wallet-transfer-form').get(0).reset();// reset the form validator object on the page
utopiasoftware.ally.controller.walletTransferPageViewModel.formValidator.reset();return _context.abrupt('return',Promise.all([ons.notification.toast("Wallet Transfer Successful!",{timeout:4000})]));case 11:case'end':return _context.stop();}}},_callee,this);}));function walletTransferSmsConfirmButtonClicked(_x2){return _ref.apply(this,arguments);}return walletTransferSmsConfirmButtonClicked;}()},/**
...
dataObject.DDATE=kendo.parseDate(dataObject.DDATE,"yyyy-MM-dd HH:mm:ss");return dataObject;// return the modified object
         ...
         */scanButtonClicked:function(){var _ref2=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee2(){var permissionStatuses;return regeneratorRuntime.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:permissionStatuses=null;// holds the permission statuses for the permissions requested
_context2.next=3;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.CAMERA]);});case 3:permissionStatuses=_context2.sent;// remove any tooltip being displayed on all forms on the page
...
$('#payments-page #payments-tabbar').get(0).setActiveTab(1);},1000);});});});});case 13:case'end':return _context2.stop();}}},_callee2,this);}));function scanButtonClicked(){return _ref2.apply(this,arguments);}return scanButtonClicked;}(),/**
...
_context3.next=6;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.WRITE_EXTERNAL_STORAGE,cordova.plugins.diagnostic.permission.READ_EXTERNAL_STORAGE]);});case 6:permissionStatuses=_context3.sent;// get the blob data when the export process is completed
...
window.plugins.toast.hide();}});}).catch(function(err){console.log("EXPORT FAILED",err);});case 8:case'end':return _context3.stop();}}},_callee3,this);}));function pdfExportComplete(_x3){return _ref3.apply(this,arguments);}return pdfExportComplete;}()});//append the newly created grid
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context4.stop();}}},_callee4,this);}));function pdfExportComplete(_x4){return _ref4.apply(this,arguments);}return pdfExportComplete;}()});// remove the loader content
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray);}).then(function(dataArray){var _ref6;console.log(dataArray);utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid=new ej.grids.Grid((_ref6={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref6,'allowTextWrap',true),_defineProperty(_ref6,'showColumnChooser',true),_defineProperty(_ref6,'allowPdfExport',true),_defineProperty(_ref6,'allowExcelExport',true),_defineProperty(_ref6,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref6,'columns',[{field:'SENDER',headerText:'Sender',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'RECEIVER',headerText:'Recipient',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',clipMode:'ellipsiswithtooltip'},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'TRANSFERTYPE',headerText:'Type',width:"25%",clipMode:'ellipsiswithtooltip',visible:false},{field:'TRANSACTIONREF',headerText:'Ref',width:"25%",clipMode:'ellipsiswithtooltip',visible:false}]),_defineProperty(_ref6,'dataSource',dataArray),_defineProperty(_ref6,'pdfExportComplete',function(){var _ref5=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee5(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context5.stop();}}},_callee5,this);}));function pdfExportComplete(_x5){return _ref5.apply(this,arguments);}return pdfExportComplete;}()),_ref6));// remove the loader content
$('#transaction-history-page #transaction-history-transaction-grid').html("");//append the newly created grid
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.appendTo('#transaction-history-transaction-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='transaction-history-transaction-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
...
// format the data array so it can be properly used
return gridDataMapping(data[periodType]);}).then(function(dataArray){var _ref8;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref8={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref8,'allowTextWrap',true),_defineProperty(_ref8,'showColumnChooser',true),_defineProperty(_ref8,'allowPdfExport',true),_defineProperty(_ref8,'allowExcelExport',true),_defineProperty(_ref8,'allowGrouping',true),_defineProperty(_ref8,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref8,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref8,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref8,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref8,'dataSource',dataArray),_defineProperty(_ref8,'pdfExportComplete',function(){var _ref7=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee6(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});case 7:case'end':return _context6.stop();}}},_callee6,this);}));function pdfExportComplete(_x8){return _ref7.apply(this,arguments);}return pdfExportComplete;}()),_ref8));//append the newly created grid
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray[periodType]);}).then(function(dataArray){var _ref10;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");// hide the spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});case 7:case'end':return _context7.stop();}}},_callee7,this);}));function pdfExportComplete(_x9){return _ref9.apply(this,arguments);}return pdfExportComplete;}()),_ref10));//append the newly created grid
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.appendTo('#expense-tracker-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='expense-tracker-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
