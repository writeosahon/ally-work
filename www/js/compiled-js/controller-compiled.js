...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context2.stop();}}},_callee2,this);}));function pdfExportComplete(_x2){return _ref2.apply(this,arguments);}return pdfExportComplete;}()});// remove the loader content
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray);}).then(function(dataArray){var _ref4;console.log(dataArray);utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid=new ej.grids.Grid((_ref4={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref4,'allowTextWrap',true),_defineProperty(_ref4,'showColumnChooser',true),_defineProperty(_ref4,'allowPdfExport',true),_defineProperty(_ref4,'allowExcelExport',true),_defineProperty(_ref4,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref4,'columns',[{field:'SENDER',headerText:'Sender',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'RECEIVER',headerText:'Recipient',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',clipMode:'ellipsiswithtooltip'},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'TRANSFERTYPE',headerText:'Type',width:"25%",clipMode:'ellipsiswithtooltip',visible:false},{field:'TRANSACTIONREF',headerText:'Ref',width:"25%",clipMode:'ellipsiswithtooltip',visible:false}]),_defineProperty(_ref4,'dataSource',dataArray),_defineProperty(_ref4,'pdfExportComplete',function(){var _ref3=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee3(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context3.stop();}}},_callee3,this);}));function pdfExportComplete(_x3){return _ref3.apply(this,arguments);}return pdfExportComplete;}()),_ref4));// remove the loader content
$('#transaction-history-page #transaction-history-transaction-grid').html("");//append the newly created grid
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.appendTo('#transaction-history-transaction-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='transaction-history-transaction-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
...
// format the data array so it can be properly used
return gridDataMapping(data[periodType]);}).then(function(dataArray){var _ref5;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref5={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref5,'allowTextWrap',true),_defineProperty(_ref5,'showColumnChooser',true),_defineProperty(_ref5,'allowPdfExport',true),_defineProperty(_ref5,'allowExcelExport',true),_defineProperty(_ref5,'allowGrouping',true),_defineProperty(_ref5,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref5,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref5,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref5,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref5,'dataSource',dataArray),_defineProperty(_ref5,'pdfExportComplete',function pdfExportComplete(pdfExportCompleteArgs){console.log("ARGUMENTS",pdfExportCompleteArgs);var fileObj=null;// variable holds the file object to be created
// get the blob data when the export process is completed
pdfExportCompleteArgs.promise.then(function(pdfData){// get the pdf structure if the content being exported
pdfExportBlob=pdfData.blobData;// get the blob for the exported pdf
console.log("EXPORTED",pdfData);return new Promise(function(resolve,reject){// return the directory where to store the document/image
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});}),_ref5));//append the newly created grid
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray[periodType]);}).then(function(dataArray){var _ref6;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref6={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref6,'allowTextWrap',true),_defineProperty(_ref6,'showColumnChooser',true),_defineProperty(_ref6,'allowPdfExport',true),_defineProperty(_ref6,'allowExcelExport',true),_defineProperty(_ref6,'allowGrouping',true),_defineProperty(_ref6,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref6,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref6,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref6,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref6,'dataSource',dataArray),_defineProperty(_ref6,'pdfExportComplete',function pdfExportComplete(pdfExportCompleteArgs){console.log("ARGUMENTS",pdfExportCompleteArgs);var fileObj=null;// variable holds the file object to be created
// get the blob data when the export process is completed
pdfExportCompleteArgs.promise.then(function(pdfData){// get the pdf structure if the content being exported
pdfExportBlob=pdfData.blobData;// get the blob for the exported pdf
console.log("EXPORTED",pdfData);return new Promise(function(resolve,reject){// return the directory where to store the document/image
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");// hide the spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});}),_ref6));//append the newly created grid
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.appendTo('#expense-tracker-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='expense-tracker-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
