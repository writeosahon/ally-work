...
dataObject.DDATE=kendo.parseDate(dataObject.DDATE,"yyyy-MM-dd HH:mm:ss");return dataObject;// return the modified object
         ...
         */scanButtonClicked:function(){var _ref3=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee3(){var permissionStatuses;return regeneratorRuntime.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:permissionStatuses=null;// holds the permission statuses for the permissions requested
_context3.next=3;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.CAMERA]);});case 3:permissionStatuses=_context3.sent;// remove any tooltip being displayed on all forms on the page
...
$('#payments-page #payments-tabbar').get(0).setActiveTab(1);},1000);});});});});case 13:case'end':return _context3.stop();}}},_callee3,this);}));function scanButtonClicked(){return _ref3.apply(this,arguments);}return scanButtonClicked;}(),/**
...
_context4.next=6;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.WRITE_EXTERNAL_STORAGE,cordova.plugins.diagnostic.permission.READ_EXTERNAL_STORAGE]);});case 6:permissionStatuses=_context4.sent;// get the blob data when the export process is completed
...
window.plugins.toast.hide();}});}).catch(function(err){console.log("EXPORT FAILED",err);});case 8:case'end':return _context4.stop();}}},_callee4,this);}));function pdfExportComplete(_x3){return _ref4.apply(this,arguments);}return pdfExportComplete;}()});//append the newly created grid
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context5.stop();}}},_callee5,this);}));function pdfExportComplete(_x4){return _ref5.apply(this,arguments);}return pdfExportComplete;}()});// remove the loader content
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray);}).then(function(dataArray){var _ref7;console.log(dataArray);utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid=new ej.grids.Grid((_ref7={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref7,'allowTextWrap',true),_defineProperty(_ref7,'showColumnChooser',true),_defineProperty(_ref7,'allowPdfExport',true),_defineProperty(_ref7,'allowExcelExport',true),_defineProperty(_ref7,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref7,'columns',[{field:'SENDER',headerText:'Sender',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'RECEIVER',headerText:'Recipient',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',clipMode:'ellipsiswithtooltip'},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'TRANSFERTYPE',headerText:'Type',width:"25%",clipMode:'ellipsiswithtooltip',visible:false},{field:'TRANSACTIONREF',headerText:'Ref',width:"25%",clipMode:'ellipsiswithtooltip',visible:false}]),_defineProperty(_ref7,'dataSource',dataArray),_defineProperty(_ref7,'pdfExportComplete',function(){var _ref6=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee6(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){console.log("EXPORT FAILED",err);});case 7:case'end':return _context6.stop();}}},_callee6,this);}));function pdfExportComplete(_x5){return _ref6.apply(this,arguments);}return pdfExportComplete;}()),_ref7));// remove the loader content
$('#transaction-history-page #transaction-history-transaction-grid').html("");//append the newly created grid
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.appendTo('#transaction-history-transaction-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.transactionHistoryPageViewModel.transactionHistoryGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='transaction-history-transaction-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
...
$('#app-main-navigator').get(0).popPage();},/**
         * method is triggered when the 'Pick Contact" button is clicked
         */pickContactButtonClicked:function(){var _ref8=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee7(){var permissionStatuses;return regeneratorRuntime.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to enable access to phone contacts
_context7.next=3;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.READ_CONTACTS,cordova.plugins.diagnostic.permission.GET_ACCOUNTS]);});case 3:permissionStatuses=_context7.sent;// display the list of contacts from the user's phone address book
new Promise(function(resolve,reject){// check if the user has given permission to write pdf file to device
if(!permissionStatuses||permissionStatuses[cordova.plugins.diagnostic.permission.READ_CONTACTS]!==cordova.plugins.diagnostic.permissionStatus.GRANTED||permissionStatuses[cordova.plugins.diagnostic.permission.GET_ACCOUNTS]!==cordova.plugins.diagnostic.permissionStatus.GRANTED){throw"error - no runtime permissions";}window.plugins.contactNumberPicker.pick(resolve,reject);}).then(function(contact){// retrieve picked contact
// get the selected contact phone number
var contactPhoneNumber=contact.phoneNumber;//format the retrieved phone number to acceptable app standards
...
window.plugins.toast.showWithOptions({message:"phone contacts could not be accessed right now",duration:4000,position:"top",styling:{opacity:1,backgroundColor:'#ff0000',//red
textColor:'#FFFFFF',textSize:14}},function(toastEvent){if(toastEvent&&toastEvent.event=="touch"){// user tapped the toast, so hide toast immediately
window.plugins.toast.hide();}});});case 5:case'end':return _context7.stop();}}},_callee7,this);}));function pickContactButtonClicked(){return _ref8.apply(this,arguments);}return pickContactButtonClicked;}()},/**
...
// format the data array so it can be properly used
return gridDataMapping(data[periodType]);}).then(function(dataArray){var _ref10;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref10={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref10,'allowTextWrap',true),_defineProperty(_ref10,'showColumnChooser',true),_defineProperty(_ref10,'allowPdfExport',true),_defineProperty(_ref10,'allowExcelExport',true),_defineProperty(_ref10,'allowGrouping',true),_defineProperty(_ref10,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref10,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref10,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref10,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref10,'dataSource',dataArray),_defineProperty(_ref10,'pdfExportComplete',function(){var _ref9=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee8(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
_context8.next=5;return new Promise(function(resolve,reject){cordova.plugins.diagnostic.requestRuntimePermissions(resolve,reject,[cordova.plugins.diagnostic.permission.WRITE_EXTERNAL_STORAGE,cordova.plugins.diagnostic.permission.READ_EXTERNAL_STORAGE]);});case 5:permissionStatuses=_context8.sent;// get the blob data when the export process is completed
pdfExportCompleteArgs.promise.then(function(pdfData){// get the pdf structure if the content being exported
pdfExportBlob=pdfData.blobData;// get the blob for the exported pdf
console.log("EXPORTED",pdfData);// check if the user has given permission to write pdf file to device
if(!permissionStatuses||permissionStatuses[cordova.plugins.diagnostic.permission.WRITE_EXTERNAL_STORAGE]!==cordova.plugins.diagnostic.permissionStatus.GRANTED||permissionStatuses[cordova.plugins.diagnostic.permission.READ_EXTERNAL_STORAGE]!==cordova.plugins.diagnostic.permissionStatus.GRANTED){throw"error - no permissions";}return new Promise(function(resolve,reject){// return the directory where to store the document/image
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});case 7:case'end':return _context8.stop();}}},_callee8,this);}));function pdfExportComplete(_x8){return _ref9.apply(this,arguments);}return pdfExportComplete;}()),_ref10));//append the newly created grid
...
// format the chart data array so it can be properly used
return gridDataMapping(dataArray[periodType]);}).then(function(dataArray){var _ref12;console.log(dataArray);// check if the Expense Tracker Grid has been created before, if so, destroy it
if(utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid){// grid has previously been created
// hide spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();// destroy the grid object
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.destroy();}utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid=new ej.grids.Grid((_ref12={// Width for grid
width:'100%',allowTextWrap:true,showColumnChooser:true},_defineProperty(_ref12,'allowTextWrap',true),_defineProperty(_ref12,'showColumnChooser',true),_defineProperty(_ref12,'allowPdfExport',true),_defineProperty(_ref12,'allowExcelExport',true),_defineProperty(_ref12,'allowGrouping',true),_defineProperty(_ref12,'groupSettings',{showDropArea:false,columns:['CATEGORY']}),_defineProperty(_ref12,'toolbar',['search','columnchooser','pdfexport']),_defineProperty(_ref12,'columns',[{field:'CATEGORY',headerText:'Category',width:"25%",clipMode:'ellipsiswithtooltip'},{field:'DESCRIPTION',headerText:'Desc.',width:"25%",clipMode:'ellipsiswithtooltip',allowGrouping:false},{field:'DDATE',headerText:'Date',width:"25%",clipMode:'ellipsiswithtooltip',visible:false,allowGrouping:false},{field:'AMOUNT',headerText:'Amount',width:"25%",textAlign:'right',format:'N2',clipMode:'ellipsiswithtooltip',allowGrouping:false}]),_defineProperty(_ref12,'aggregates',[{columns:[{type:'sum',field:'AMOUNT',format:'N2',groupFooterTemplate:'Sub-total: ${sum}',footerTemplate:'Total: ${sum}'}]}]),_defineProperty(_ref12,'dataSource',dataArray),_defineProperty(_ref12,'pdfExportComplete',function(){var _ref11=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee9(pdfExportCompleteArgs){var fileObj,permissionStatuses;return regeneratorRuntime.wrap(function _callee9$(_context9){while(1){switch(_context9.prev=_context9.next){case 0:console.log("ARGUMENTS",pdfExportCompleteArgs);fileObj=null;// variable holds the file object to be created
permissionStatuses=null;// holds the statuses of the runtime permissions requested
// request runtime permissions to write pdf file to device
...
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");// hide the spinner
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();ons.notification.toast("PDF Exported to Root Folder!",{timeout:4000});}).catch(function(err){utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.groupColumn("CATEGORY");utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.hideSpinner();});case 7:case'end':return _context9.stop();}}},_callee9,this);}));function pdfExportComplete(_x9){return _ref11.apply(this,arguments);}return pdfExportComplete;}()),_ref12));//append the newly created grid
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.appendTo('#expense-tracker-grid');// append the listener for the toolbar 'Export PDF' button click
utopiasoftware.ally.controller.expenseTrackerPageViewModel.expenseTrackerGrid.toolbarClick=function(args){console.log("ID ",args.item.id);if(args.item.id==='expense-tracker-grid_pdfexport'){// the toolbar button being clicked is the 'PDF Export'
