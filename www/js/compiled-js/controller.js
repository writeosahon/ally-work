...
utopiasoftware.ally.controller = {
    ...
    paymentsAllyDirectPageViewModel: {
        ...
        findButtonClicked: function(){
            ...
            if(utopiasoftware.ally.controller.paymentsAllyDirectPageViewModel.merchantCodeValidator.validate() !== true){
            ...
            then(function(serverResponse){
                ...
                // display the 'PAY' button via animation
                let animatePayButton = new ej.base.Animation({name: 'ZoomIn', duration: 1000, end: function(){
                    $('#payments-ally-direct-pay-button').css("transform", "scale(1)");
                }});
                animatePayButton.animate('#payments-ally-direct-pay-button');

                // display the form input elements
                // show the merchant details form inputs
                $('#payments-ally-direct-page .pay-ally-direct-merchant-details').css("visibility", "visible");
            }).
            then(function(){
                $('#hour-glass-loader-modal').get(0).hide(); // hide loader
            }).
